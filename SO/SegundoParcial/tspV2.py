...
def heuristicaNN_UnicoArranque(nodos,conexiones, ii=0):
...
rutaInstancia = sys.argv[1]
nodoArranque = int(sys.argv[2])


#Cargar nodos desde archivo
nodos = cargarCasoTSP(rutaInstancia)
...
pp.pprint(heuristicaNN_UnicoArranque(nodos, conexiones, nodoArranque)) 
